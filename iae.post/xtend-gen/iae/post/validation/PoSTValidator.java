...
public class PoSTValidator extends AbstractPoSTValidator {
  ...
  public void checkSymbolicVariable_NameConflicts(final SymbolicVariable ele) {
    ...
    if (((program != null) && (model.getConf() != null))) {
      ...
      final Predicate<Resource> _function = new Predicate<Resource>() {
        public boolean test(final Resource r) {
          return PoSTValidator.this.checkNameRepetition(r, ele);
        }
      };
  ...
  public void checkProgramConfiguration_NumberOfArgs(final ProgramConfiguration ele) {
    ...
    final Function<InputVarDeclaration, EList<VarInitDeclaration>> _function = new Function<InputVarDeclaration, EList<VarInitDeclaration>>() {
      public EList<VarInitDeclaration> apply(final InputVarDeclaration x) {
        return x.getVars();
      }
    };
    final Function<EList<VarInitDeclaration>, Stream<VarInitDeclaration>> _function_1 = new Function<EList<VarInitDeclaration>, Stream<VarInitDeclaration>>() {
      public Stream<VarInitDeclaration> apply(final EList<VarInitDeclaration> x) {
        return x.stream();
      }
    };
    final Function<VarInitDeclaration, EList<SymbolicVariable>> _function_2 = new Function<VarInitDeclaration, EList<SymbolicVariable>>() {
      public EList<SymbolicVariable> apply(final VarInitDeclaration x) {
        return x.getVarList().getVars();
      }
    };
    final Function<EList<SymbolicVariable>, Stream<SymbolicVariable>> _function_3 = new Function<EList<SymbolicVariable>, Stream<SymbolicVariable>>() {
    ...
    final Function<OutputVarDeclaration, EList<VarInitDeclaration>> _function_4 = new Function<OutputVarDeclaration, EList<VarInitDeclaration>>() {
      public EList<VarInitDeclaration> apply(final OutputVarDeclaration x) {
        return x.getVars();
      }
    };
    final Function<EList<VarInitDeclaration>, Stream<VarInitDeclaration>> _function_5 = new Function<EList<VarInitDeclaration>, Stream<VarInitDeclaration>>() {
      public Stream<VarInitDeclaration> apply(final EList<VarInitDeclaration> x) {
        return x.stream();
      }
    };
    final Function<VarInitDeclaration, EList<SymbolicVariable>> _function_6 = new Function<VarInitDeclaration, EList<SymbolicVariable>>() {
      public EList<SymbolicVariable> apply(final VarInitDeclaration x) {
        return x.getVarList().getVars();
      }
    };
    final Function<EList<SymbolicVariable>, Stream<SymbolicVariable>> _function_7 = new Function<EList<SymbolicVariable>, Stream<SymbolicVariable>>() {
      public Stream<SymbolicVariable> apply(final EList<SymbolicVariable> x) {
        return x.stream();
      }
    };
    ...
    final Function<InputOutputVarDeclaration, EList<VarInitDeclaration>> _function_8 = new Function<InputOutputVarDeclaration, EList<VarInitDeclaration>>() {
      public EList<VarInitDeclaration> apply(final InputOutputVarDeclaration x) {
        return x.getVars();
      }
    };
    final Function<EList<VarInitDeclaration>, Stream<VarInitDeclaration>> _function_9 = new Function<EList<VarInitDeclaration>, Stream<VarInitDeclaration>>() {
      public Stream<VarInitDeclaration> apply(final EList<VarInitDeclaration> x) {
        return x.stream();
      }
    };
    final Function<VarInitDeclaration, EList<SymbolicVariable>> _function_10 = new Function<VarInitDeclaration, EList<SymbolicVariable>>() {
      public EList<SymbolicVariable> apply(final VarInitDeclaration x) {
        return x.getVarList().getVars();
      }
    };
    final Function<EList<SymbolicVariable>, Stream<SymbolicVariable>> _function_11 = new Function<EList<SymbolicVariable>, Stream<SymbolicVariable>>() {
      public Stream<SymbolicVariable> apply(final EList<SymbolicVariable> x) {
        return x.stream();
      }
    };
    ...
    final Predicate<ProgramConfElement> _function_12 = new Predicate<ProgramConfElement>() {
      public boolean test(final ProgramConfElement x) {
  ...
  public void checkTemplateProcessConfElement_NumberOfArgs(final TemplateProcessConfElement ele) {
    ...
    final iae.post.poST.Process process = ele.getProcess();
    final Function<InputVarDeclaration, EList<VarInitDeclaration>> _function = new Function<InputVarDeclaration, EList<VarInitDeclaration>>() {
      public EList<VarInitDeclaration> apply(final InputVarDeclaration x) {
        return x.getVars();
      }
    ...
    final Function<ProcessVarDeclaration, EList<ProcessVarInitDeclaration>> _function_12 = new Function<ProcessVarDeclaration, EList<ProcessVarInitDeclaration>>() {
      public EList<ProcessVarInitDeclaration> apply(final ProcessVarDeclaration x) {
        return x.getVars();
      }
    };
    final Function<EList<ProcessVarInitDeclaration>, Stream<ProcessVarInitDeclaration>> _function_13 = new Function<EList<ProcessVarInitDeclaration>, Stream<ProcessVarInitDeclaration>>() {
      public Stream<ProcessVarInitDeclaration> apply(final EList<ProcessVarInitDeclaration> x) {
        return x.stream();
      }
    };
    final Function<ProcessVarInitDeclaration, EList<ProcessVariable>> _function_14 = new Function<ProcessVarInitDeclaration, EList<ProcessVariable>>() {
      public EList<ProcessVariable> apply(final ProcessVarInitDeclaration x) {
        return x.getVarList().getVars();
      }
    };
    final Function<EList<ProcessVariable>, Stream<ProcessVariable>> _function_15 = new Function<EList<ProcessVariable>, Stream<ProcessVariable>>() {
  ...
  @Check
  public void checkProcess_NameConflicts(final iae.post.poST.Process ele) {
    final Program program = EcoreUtil2.<Program>getContainerOfType(ele, Program.class);
  ...
  @Check
  public void checkProcess_UpperCase(final iae.post.poST.Process ele) {
    boolean _isUpperCase = Character.isUpperCase(ele.getName().charAt(0));
    boolean _not = (!_isUpperCase);
    if (_not) {
  ...
  @Check
  public void checkProcess_Empty(final iae.post.poST.Process ele) {
  ...
  @Check
  public void checkProcess_Unreachable(final iae.post.poST.Process ele) {
  ...
  @Check
  public void checkState_NameConflicts(final iae.post.poST.State ele) {
    final iae.post.poST.Process process = EcoreUtil2.<iae.post.poST.Process>getContainerOfType(ele, iae.post.poST.Process.class);
  ...
  @Check
  public void checkState_Empty(final iae.post.poST.State ele) {
  ...
  @Check
  public void checkState_Unreachable(final iae.post.poST.State ele) {
    final iae.post.poST.Process process = EcoreUtil2.<iae.post.poST.Process>getContainerOfType(ele, iae.post.poST.Process.class);
  ...
  @Check
  public void checkState_Looped(final iae.post.poST.State ele) {
  ...
  public void checkSetStateStatement_Useless(final SetStateStatement ele) {
    final iae.post.poST.State state = EcoreUtil2.<iae.post.poST.State>getContainerOfType(ele, iae.post.poST.State.class);
    iae.post.poST.State _state = ele.getState();
  ...
  public void checkSetStateStatement_Next(final SetStateStatement ele) {
    ...
    final iae.post.poST.Process process = EcoreUtil2.<iae.post.poST.Process>getContainerOfType(ele, iae.post.poST.Process.class);
    final iae.post.poST.State state = EcoreUtil2.<iae.post.poST.State>getContainerOfType(ele, iae.post.poST.State.class);
    iae.post.poST.State _last = IterableExtensions.<iae.post.poST.State>last(process.getStates());
  ...
  private void checkProcessStatement_InvalidArgument(final EObject context, final Variable ele) {
    ...
    if ((ele instanceof iae.post.poST.Process)) {
      final Program program = EcoreUtil2.<Program>getContainerOfType(ele, Program.class);
  ...
  public void checkFunctionCall_NumberOfArgs(final FunctionCall ele) {
    final iae.post.poST.Function function = ele.getFunction();
    final Function<InputVarDeclaration, EList<VarInitDeclaration>> _function = new Function<InputVarDeclaration, EList<VarInitDeclaration>>() {
      public EList<VarInitDeclaration> apply(final InputVarDeclaration x) {
        return x.getVars();
      }
  ...
  private <T extends Statement> boolean checkProcessStart(final EList<iae.post.poST.Process> processList, final iae.post.poST.Process ele) {
    final Predicate<iae.post.poST.Process> _function = new Predicate<iae.post.poST.Process>() {
      public boolean test(final iae.post.poST.Process x) {
        return (x != ele);
      }
    };
    final Predicate<iae.post.poST.Process> _function_1 = new Predicate<iae.post.poST.Process>() {
      public boolean test(final iae.post.poST.Process x) {
        final Predicate<StartProcessStatement> _function = new Predicate<StartProcessStatement>() {
          public boolean test(final StartProcessStatement xx) {
            Variable _process = xx.getProcess();
            return (_process == ele);
          }
        };
        return EcoreUtil2.<StartProcessStatement>getAllContentsOfType(x, StartProcessStatement.class).stream().anyMatch(_function);
      }
    };
    return processList.stream().filter(_function).anyMatch(_function_1);
  }
  
  private <T extends Statement> boolean checkStateSet(final EList<iae.post.poST.State> stateList, final iae.post.poST.State ele) {
    final Predicate<iae.post.poST.State> _function = new Predicate<iae.post.poST.State>() {
      public boolean test(final iae.post.poST.State x) {
        return (x != ele);
      }
    };
    final Predicate<iae.post.poST.State> _function_1 = new Predicate<iae.post.poST.State>() {
      public boolean test(final iae.post.poST.State x) {
        final Predicate<SetStateStatement> _function = new Predicate<SetStateStatement>() {
          public boolean test(final SetStateStatement xx) {
            iae.post.poST.State _state = xx.getState();
            return (_state == ele);
          }
        };
        return EcoreUtil2.<SetStateStatement>getAllContentsOfType(x, SetStateStatement.class).stream().anyMatch(_function);
      }
    };
    return stateList.stream().filter(_function).anyMatch(_function_1);
  }
  
  private <T extends Statement> boolean checkStateSetNext(final EList<iae.post.poST.State> stateList, final int index) {
    final Predicate<SetStateStatement> _function = new Predicate<SetStateStatement>() {
      public boolean test(final SetStateStatement xx) {
        return xx.isNext();
      }
  ...
  private boolean isTemplate(final iae.post.poST.Process process) {
  ...
  private boolean checkNameRepetition(final Model model, final Program ele) {
    return (model.getPrograms().stream().anyMatch(new Predicate<Program>() {
      public boolean test(final Program x) {
        return ((x != ele) && x.getName().equals(ele.getName()));
      }
    }) || 
      model.getFbs().stream().anyMatch(new Predicate<FunctionBlock>() {
        public boolean test(final FunctionBlock x) {
  ...
  private boolean checkNameRepetition(final Program program, final iae.post.poST.Process ele) {
    final Predicate<iae.post.poST.Process> _function = new Predicate<iae.post.poST.Process>() {
      public boolean test(final iae.post.poST.Process x) {
        return ((x != ele) && x.getName().equals(ele.getName()));
      }
  ...
  private boolean checkNameRepetition(final iae.post.poST.Process process, final iae.post.poST.State ele) {
    final Predicate<iae.post.poST.State> _function = new Predicate<iae.post.poST.State>() {
      public boolean test(final iae.post.poST.State x) {
        return ((x != ele) && x.getName().equals(ele.getName()));
      }
  ...
  private boolean checkNameRepetition(final FunctionBlock fb, final iae.post.poST.Process ele) {
    final Predicate<iae.post.poST.Process> _function = new Predicate<iae.post.poST.Process>() {
      public boolean test(final iae.post.poST.Process x) {
        return ((x != ele) && x.getName().equals(ele.getName()));
      }
  ...
  private boolean checkNameRepetition(final Configuration configuration, final Resource ele) {
    final Predicate<Resource> _function = new Predicate<Resource>() {
      public boolean test(final Resource x) {
        return ((x != ele) && x.getName().equals(ele.getName()));
      }
    };
  ...
  private boolean checkNameRepetition(final Resource resource, final Task ele) {
    final Predicate<Task> _function = new Predicate<Task>() {
      public boolean test(final Task x) {
        return ((x != ele) && x.getName().equals(ele.getName()));
      }
    };
  ...
  private boolean checkNameRepetition(final Resource resource, final ProgramConfiguration ele) {
    final Predicate<ProgramConfiguration> _function = new Predicate<ProgramConfiguration>() {
      public boolean test(final ProgramConfiguration x) {
        return ((x != ele) && x.getName().equals(ele.getName()));
      }
    };
  ...
  private boolean checkNameRepetition(final ProgramConfiguration programConf, final TemplateProcessConfElement ele) {
    final Predicate<ProgramConfElement> _function = new Predicate<ProgramConfElement>() {
      public boolean test(final ProgramConfElement x) {
        return (x instanceof TemplateProcessConfElement);
      }
    };
    final Predicate<ProgramConfElement> _function_1 = new Predicate<ProgramConfElement>() {
      public boolean test(final ProgramConfElement x) {
  ...
  private boolean checkNameRepetition(final Program program, final TemplateProcessConfElement ele) {
    ...
    final Predicate<iae.post.poST.Process> _function = new Predicate<iae.post.poST.Process>() {
      public boolean test(final iae.post.poST.Process x) {
        return ((!PoSTValidator.this.isTemplate(x)) && x.getName().equals(name));
      }
    };
    return program.getProcesses().stream().anyMatch(_function);
  }
  ...
  private boolean checkNameRepetition(final iae.post.poST.Process process, final SymbolicVariable ele) {
  ...
  private boolean checkNameRepetition(final iae.post.poST.Process process, final ProcessVariable ele) {
  ...
  private boolean checkVarRepetition_InputVarDeclaration(final EList<InputVarDeclaration> varList, final SymbolicVariable ele) {
    final Predicate<InputVarDeclaration> _function = new Predicate<InputVarDeclaration>() {
      public boolean test(final InputVarDeclaration x) {
        return PoSTValidator.this.checkVarRepetition_VarInitDeclaration(x.getVars(), ele);
      }
    };
  ...
  private boolean checkVarRepetition_OutputVarDeclaration(final EList<OutputVarDeclaration> varList, final SymbolicVariable ele) {
    final Predicate<OutputVarDeclaration> _function = new Predicate<OutputVarDeclaration>() {
      public boolean test(final OutputVarDeclaration x) {
        return PoSTValidator.this.checkVarRepetition_VarInitDeclaration(x.getVars(), ele);
      }
    };
    return varList.stream().anyMatch(_function);
  ...
  private boolean checkVarRepetition_InputOutputVarDeclaration(final EList<InputOutputVarDeclaration> varList, final SymbolicVariable ele) {
    final Predicate<InputOutputVarDeclaration> _function = new Predicate<InputOutputVarDeclaration>() {
      public boolean test(final InputOutputVarDeclaration x) {
        return PoSTValidator.this.checkVarRepetition_VarInitDeclaration(x.getVars(), ele);
      }
    };
    return varList.stream().anyMatch(_function);
  ...
  private boolean checkVarRepetition_VarDeclaration(final EList<VarDeclaration> varList, final SymbolicVariable ele) {
    final Predicate<VarDeclaration> _function = new Predicate<VarDeclaration>() {
      public boolean test(final VarDeclaration x) {
        return PoSTValidator.this.checkVarRepetition_VarInitDeclaration(x.getVars(), ele);
      }
    };
    return varList.stream().anyMatch(_function);
  ...
  private boolean checkVarRepetition_TempVarDeclaration(final EList<TempVarDeclaration> varList, final SymbolicVariable ele) {
    final Predicate<TempVarDeclaration> _function = new Predicate<TempVarDeclaration>() {
      public boolean test(final TempVarDeclaration x) {
        return PoSTValidator.this.checkVarRepetition_VarInitDeclaration(x.getVars(), ele);
      }
    };
    return varList.stream().anyMatch(_function);
  ...
  private boolean checkVarRepetition_ExternalVarDeclaration(final EList<ExternalVarDeclaration> varList, final SymbolicVariable ele) {
    final Predicate<ExternalVarDeclaration> _function = new Predicate<ExternalVarDeclaration>() {
      public boolean test(final ExternalVarDeclaration x) {
        return PoSTValidator.this.checkVarRepetition_ExternalVarInitDeclaration(x.getVars(), ele);
      }
    };
    return varList.stream().anyMatch(_function);
  }
  ...
  private boolean checkVarRepetition_GlobalVarDeclaration(final EList<GlobalVarDeclaration> varList, final SymbolicVariable ele) {
    return (varList.stream().anyMatch(new Predicate<GlobalVarDeclaration>() {
      public boolean test(final GlobalVarDeclaration x) {
        return PoSTValidator.this.checkVarRepetition_VarInitDeclaration(x.getVarsSimple(), ele);
      }
    }) || 
      varList.stream().anyMatch(new Predicate<GlobalVarDeclaration>() {
        public boolean test(final GlobalVarDeclaration x) {
          return PoSTValidator.this.checkVarRepetition_GlobalVarInitDeclaration(x.getVarsAs(), ele);
        }
      }));
  }
  ...
  private boolean checkVarRepetition_ProcessVarDeclaration(final EList<ProcessVarDeclaration> varList, final ProcessVariable ele) {
    final Predicate<ProcessVarDeclaration> _function = new Predicate<ProcessVarDeclaration>() {
      public boolean test(final ProcessVarDeclaration x) {
        return PoSTValidator.this.checkVarRepetition_ProcessVarInitDeclaration(x.getVars(), ele);
      }
    };
    return varList.stream().anyMatch(_function);
  }
  ...
  private boolean checkVarRepetition_VarInitDeclaration(final EList<VarInitDeclaration> varList, final SymbolicVariable ele) {
    final Function<VarInitDeclaration, EList<SymbolicVariable>> _function = new Function<VarInitDeclaration, EList<SymbolicVariable>>() {
      public EList<SymbolicVariable> apply(final VarInitDeclaration x) {
        return x.getVarList().getVars();
      }
    };
    final Function<EList<SymbolicVariable>, Stream<SymbolicVariable>> _function_1 = new Function<EList<SymbolicVariable>, Stream<SymbolicVariable>>() {
      public Stream<SymbolicVariable> apply(final EList<SymbolicVariable> x) {
        return x.stream();
      }
    };
    final Predicate<SymbolicVariable> _function_2 = new Predicate<SymbolicVariable>() {
  ...
  private boolean checkVarRepetition_ExternalVarInitDeclaration(final EList<ExternalVarInitDeclaration> varList, final SymbolicVariable ele) {
    final Function<ExternalVarInitDeclaration, EList<SymbolicVariable>> _function = new Function<ExternalVarInitDeclaration, EList<SymbolicVariable>>() {
  ...
  private boolean checkVarRepetition_GlobalVarInitDeclaration(final EList<GlobalVarInitDeclaration> varList, final SymbolicVariable ele) {
    final Function<GlobalVarInitDeclaration, EList<SymbolicVariable>> _function = new Function<GlobalVarInitDeclaration, EList<SymbolicVariable>>() {
  ...
  private boolean checkVarRepetition_ProcessVarInitDeclaration(final EList<ProcessVarInitDeclaration> varList, final ProcessVariable ele) {
    final Function<ProcessVarInitDeclaration, EList<ProcessVariable>> _function = new Function<ProcessVarInitDeclaration, EList<ProcessVariable>>() {
      public EList<ProcessVariable> apply(final ProcessVarInitDeclaration x) {
        return x.getVarList().getVars();
      }
    };
    final Function<EList<ProcessVariable>, Stream<ProcessVariable>> _function_1 = new Function<EList<ProcessVariable>, Stream<ProcessVariable>>() {
      public Stream<ProcessVariable> apply(final EList<ProcessVariable> x) {
        return x.stream();
      }
    };
    final Predicate<ProcessVariable> _function_2 = new Predicate<ProcessVariable>() {
      public boolean test(final ProcessVariable x) {
        return ((x != ele) && x.getName().equals(ele.getName()));
      }
    };
