...
public abstract class AbstractPoSTSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PoSTPackage.eINSTANCE)
			...
			case PoSTPackage.PROCESS:
				sequence_Process(context, (iae.post.poST.Process) semanticObject); 
				return; 
	 ...
	 * </pre>
	 */
	protected void sequence_Process(ISerializationContext context, iae.post.poST.Process semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
