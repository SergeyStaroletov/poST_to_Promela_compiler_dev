 ...
 * </p>
 * <ul>
 *   <li>{@link iae.post.poST.CaseElement#getCaseList <em>Case List</em>}</li>
 *   <li>{@link iae.post.poST.CaseElement#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @see iae.post.poST.PoSTPackage#getCaseElement()
 * @model
 * @generated
 */
public interface CaseElement extends EObject
{
   ...
   * @see iae.post.poST.PoSTPackage#getCaseElement_CaseList()
  ...
  /**
   * Sets the value of the '{@link iae.post.poST.CaseElement#getCaseList <em>Case List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see iae.post.poST.PoSTPackage#getCaseElement_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link iae.post.poST.CaseElement#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
