 ...
 * </p>
 * <ul>
 *   <li>{@link iae.post.poST.Process#getProcInVars <em>Proc In Vars</em>}</li>
 *   <li>{@link iae.post.poST.Process#getProcOutVars <em>Proc Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.Process#getProcInOutVars <em>Proc In Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.Process#getProcProcessVars <em>Proc Process Vars</em>}</li>
 *   <li>{@link iae.post.poST.Process#getProcVars <em>Proc Vars</em>}</li>
 *   <li>{@link iae.post.poST.Process#getProcTempVars <em>Proc Temp Vars</em>}</li>
 *   <li>{@link iae.post.poST.Process#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see iae.post.poST.PoSTPackage#getProcess()
 * @model
 * @generated
 */
public interface Process extends Variable
{
   ...
   * @see iae.post.poST.PoSTPackage#getProcess_ProcInVars()
   ...
   * @see iae.post.poST.PoSTPackage#getProcess_ProcOutVars()
   * @model containment="true"
   * @generated
   */
   ...
   * @see iae.post.poST.PoSTPackage#getProcess_ProcInOutVars()
   * @model containment="true"
   * @generated
   */
   ...
   * The list contents are of type {@link iae.post.poST.ProcessVarDeclaration}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Proc Process Vars</em>' containment reference list.
   * @see iae.post.poST.PoSTPackage#getProcess_ProcProcessVars()
   * @model containment="true"
   * @generated
   */
   ...
   * @see iae.post.poST.PoSTPackage#getProcess_ProcVars()
   * @model containment="true"
   * @generated
   */
   ...
   * @see iae.post.poST.PoSTPackage#getProcess_ProcTempVars()
   * @model containment="true"
   * @generated
   */
   ...
   * The list contents are of type {@link iae.post.poST.State}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>States</em>' containment reference list.
   * @see iae.post.poST.PoSTPackage#getProcess_States()
   * @model containment="true"
   * @generated
   */
