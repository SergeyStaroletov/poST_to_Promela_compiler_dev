 ...
 * </p>
 * <ul>
 *   <li>{@link iae.post.poST.impl.PrimaryExpressionImpl#getConst <em>Const</em>}</li>
 *   <li>{@link iae.post.poST.impl.PrimaryExpressionImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link iae.post.poST.impl.PrimaryExpressionImpl#getArray <em>Array</em>}</li>
 *   <li>{@link iae.post.poST.impl.PrimaryExpressionImpl#getProcStatus <em>Proc Status</em>}</li>
 *   <li>{@link iae.post.poST.impl.PrimaryExpressionImpl#getFunCall <em>Fun Call</em>}</li>
 *   <li>{@link iae.post.poST.impl.PrimaryExpressionImpl#getNestExpr <em>Nest Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
