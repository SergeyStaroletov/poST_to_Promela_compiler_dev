 ...
 * </p>
 * <ul>
 *   <li>{@link iae.post.poST.impl.ProcessImpl#getProcInVars <em>Proc In Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProcessImpl#getProcOutVars <em>Proc Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProcessImpl#getProcInOutVars <em>Proc In Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProcessImpl#getProcProcessVars <em>Proc Process Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProcessImpl#getProcVars <em>Proc Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProcessImpl#getProcTempVars <em>Proc Temp Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProcessImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessImpl extends VariableImpl implements iae.post.poST.Process
{
  /**
