 ...
 * </p>
 * <ul>
 *   <li>{@link iae.post.poST.impl.FunctionBlockImpl#getName <em>Name</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionBlockImpl#getFbInVars <em>Fb In Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionBlockImpl#getFbOutVars <em>Fb Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionBlockImpl#getFbInOutVars <em>Fb In Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionBlockImpl#getFbVars <em>Fb Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionBlockImpl#getFbTempVars <em>Fb Temp Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionBlockImpl#getFbExternVars <em>Fb Extern Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionBlockImpl#getProcesses <em>Processes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionBlockImpl extends MinimalEObjectImpl.Container implements FunctionBlock
{
   ...
   * @ordered
   */
  protected EList<iae.post.poST.Process> processes;
   ...
   */
  @Override
  public EList<iae.post.poST.Process> getProcesses()
  {
    if (processes == null)
    {
      processes = new EObjectContainmentEList<iae.post.poST.Process>(iae.post.poST.Process.class, this, PoSTPackage.FUNCTION_BLOCK__PROCESSES);
    }
    return processes;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case PoSTPackage.FUNCTION_BLOCK__PROCESSES:
        getProcesses().clear();
        getProcesses().addAll((Collection<? extends iae.post.poST.Process>)newValue);
        return;
    }
