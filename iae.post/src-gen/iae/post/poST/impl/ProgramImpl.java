 ...
 * </p>
 * <ul>
 *   <li>{@link iae.post.poST.impl.ProgramImpl#getName <em>Name</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProgramImpl#getProgInVars <em>Prog In Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProgramImpl#getProgOutVars <em>Prog Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProgramImpl#getProgInOutVars <em>Prog In Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProgramImpl#getProgVars <em>Prog Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProgramImpl#getProgTempVars <em>Prog Temp Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProgramImpl#getProgExternVars <em>Prog Extern Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.ProgramImpl#getProcesses <em>Processes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program
{
  ...
  public EList<iae.post.poST.Process> getProcesses()
  {
    if (processes == null)
    {
      processes = new EObjectContainmentEList<iae.post.poST.Process>(iae.post.poST.Process.class, this, PoSTPackage.PROGRAM__PROCESSES);
    }
    return processes;
  }
