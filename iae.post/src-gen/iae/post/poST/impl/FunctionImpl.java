 ...
 * </p>
 * <ul>
 *   <li>{@link iae.post.poST.impl.FunctionImpl#getName <em>Name</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionImpl#getType <em>Type</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionImpl#getFunInVars <em>Fun In Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionImpl#getFunOutVars <em>Fun Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionImpl#getFunInOutVars <em>Fun In Out Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionImpl#getFunVars <em>Fun Vars</em>}</li>
 *   <li>{@link iae.post.poST.impl.FunctionImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
