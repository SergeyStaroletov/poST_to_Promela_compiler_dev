 ...
 * </p>
 * <ul>
 *   <li>{@link iae.post.poST.VarInitDeclaration#getVarList <em>Var List</em>}</li>
 *   <li>{@link iae.post.poST.VarInitDeclaration#getSpec <em>Spec</em>}</li>
 *   <li>{@link iae.post.poST.VarInitDeclaration#getArrSpec <em>Arr Spec</em>}</li>
 *   <li>{@link iae.post.poST.VarInitDeclaration#getFb <em>Fb</em>}</li>
 * </ul>
 *
 * @see iae.post.poST.PoSTPackage#getVarInitDeclaration()
 * @model
 * @generated
 */
public interface VarInitDeclaration extends EObject
{
   ...
   * @see iae.post.poST.PoSTPackage#getVarInitDeclaration_VarList()
  ...
  /**
   * Sets the value of the '{@link iae.post.poST.VarInitDeclaration#getVarList <em>Var List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see iae.post.poST.PoSTPackage#getVarInitDeclaration_Spec()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link iae.post.poST.VarInitDeclaration#getSpec <em>Spec</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see iae.post.poST.PoSTPackage#getVarInitDeclaration_ArrSpec()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link iae.post.poST.VarInitDeclaration#getArrSpec <em>Arr Spec</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see iae.post.poST.PoSTPackage#getVarInitDeclaration_Fb()
   * @model
   * @generated
   */
  FunctionBlock getFb();
  ...
  /**
   * Sets the value of the '{@link iae.post.poST.VarInitDeclaration#getFb <em>Fb</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
